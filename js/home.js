...
document.querySelectorAll(".link-item").forEach(el=>{
  ...
  const set=i=>dots.forEach((d,n)=>d.classList.toggle("active",n===i));
  ...
  function next(){const n=(idx()+1)%dots.length;track.scrollTo({left:n*track.offsetWidth,behavior:"smooth"});}
